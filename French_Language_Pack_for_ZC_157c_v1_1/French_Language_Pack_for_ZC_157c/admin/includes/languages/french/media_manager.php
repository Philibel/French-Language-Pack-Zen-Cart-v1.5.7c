...
define('HEADING_TITLE_MEDIA_MANAGER', 'Gestion des Médias');
...
define('TEXT_DELETE_INTRO', 'Êtes-vous certain(e) de vouloir supprimer cette collection de médias ?');
  define('TEXT_DISPLAY_NUMBER_OF_MEDIA', 'Affiche <strong>%d</strong> à <strong>%d</strong> (sur <strong>%d</strong> collections de médias)');
define('TEXT_ADD_MEDIA_CLIP', 'Ajouter un clip média');
define('TEXT_MEDIA_CLIP_DIR', 'Uploader dans le répertoire des médias');
...
define('TEXT_WARNING_FOLDER_UNWRITABLE', 'REMARQUE : le dossier multimédia ' . DIR_FS_CATALOG_MEDIA . ' n\'est pas accessible en écriture. Impossible de télécharger les fichiers.');

define('ERROR_UNKNOWN_DATA', 'ERREUR: Données inconnues fournies ... Opération annulée');
