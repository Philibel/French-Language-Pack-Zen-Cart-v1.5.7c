...
define('TEXT_INFO_CLASS_TITLE', 'Intitulé de la classe de taxes :');
...
define('TEXT_INFO_INSERT_INTRO', 'Veuillez saisir la nouvelle classe de taxes avec ses données relatives');
define('TEXT_INFO_DELETE_INTRO', 'Êtes-vous certain de vouloir supprimer cette classe de taxes ?');
