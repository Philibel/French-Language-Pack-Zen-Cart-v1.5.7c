...
define('HEADING_TITLE', 'Gestion du prix des produits');
...
define('TEXT_PRICE_NET', 'Prix (Net)');
define('TEXT_PRICE_GROSS', 'Prix (Brut)');
...
define('TEXT_PRODUCT_INFO_NONE', 'Veuillez sélectionner un produit au-dessus ...');
  ...
  define('TEXT_PRODUCTS_PRICED_BY_ATTRIBUTES_EDIT','<br />*Le prix affiché incluera le plus bas prix dans chaque groupe d\'attributs plus le prix');
...
define('TEXT_FEATURED_CONFIRM_DELETE', 'Veuillez confirmer que vous voulez supprimer le statut en vedette associé à ce produit');

define('TEXT_SPECIALS_PRODUCT', 'Produit:');
define('TEXT_SPECIALS_SPECIAL_PRICE', 'Prix promotionnel :');
define('TEXT_SPECIALS_SPECIAL_PRICE_NET', 'Prix promotionnel : (Net)');
define('TEXT_SPECIALS_SPECIAL_PRICE_GROSS', 'Prix promotionnel : (Brut)');
...
define('TEXT_SPECIALS_CONFIRM_DELETE', 'Veuillez confirmer que vous voulez supprimer le statut promotion associé à ce produit');
...
define('TEXT_INFO_DELETE_INTRO', 'Êtes-vous certain(e) de vouloir supprimer ce produit phare ?');
  ...
  define('TEXT_ATTRIBUTES_INSERT_INFO', '<strong>Définissez les paramètres d\'attribut et appuyez sur Insérer</strong>');
...
define('TEXT_BLANKS_INFO','Toutes les remises par quantité à blanc seront supprimées à la mise à jour');
...
define('TEXT_PRODUCTS_DISCOUNT_PRICE_EACH_TAX','Prix<br />calculé: &nbsp; taxes comprises:');
define('TEXT_PRODUCTS_DISCOUNT_PRICE_EXTENDED_TAX','Prix<br />étendu: &nbsp; taxes comprises:');

define('TEXT_DISCOUNT_TYPE_INFO', 'Infos remise sur produit');
define('TEXT_DISCOUNT_TYPE','Type de remise:');
define('TEXT_DISCOUNT_TYPE_FROM', 'Prix avec remise fixé depuis:');
...
define('TEXT_INFO_MASTER_CATEGORIES_ID_UPDATE_TO_CURRENT', 'Mettez à jour le catégorie principale avec ID# %s pour qu\'il corresponde à le catégorie actuel ID# %s');
...
define('TEXT_INFO_UPDATE_REMINDER', '<strong>Éditez les informations du produit puis appuyez sur Actualisez pour enregistrer</strong>');
