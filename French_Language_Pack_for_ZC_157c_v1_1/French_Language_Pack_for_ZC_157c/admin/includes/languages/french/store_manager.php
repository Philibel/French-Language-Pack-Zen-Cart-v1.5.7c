 ...
 */
  ...
  define('HEADING_TITLE', 'Gestion de la Boutique');
  ...
  define('TEXT_INFO_SET_NEXT_ORDER_NUMBER', '<strong>Positionner le numéro de commande suivant</strong><br />NOTE : Vous ne pouvez pas positionner le numéro de commande à une valeur inférieure à toute commande déjà existante dans la BDD.');
  ...
  define('TEXT_LANGUAGE_LOOKUP_CURRENT_LANGUAGE', 'Tous les fichiers de langue ' . strtoupper($_SESSION['language']) . ' du Catalogue et de l\'Admin');
  ...
  define('TEXT_LANGUAGE_LOOKUP_CURRENT_ADMIN', 'Tous les principaux fichiers de langue de l\'Admin (' . DIR_WS_ADMIN . DIR_WS_LANGUAGES . 'english.php /french.php etc.)');
  define('TEXT_LANGUAGE_LOOKUP_CURRENT_ADMIN_LANGUAGE', 'Tous les fichiers de la langue en cours de l\'Admin (' . DIR_WS_ADMIN . DIR_WS_LANGUAGES . $_SESSION['language'] . '/*.php)');
  define('TEXT_LANGUAGE_LOOKUP_CURRENT_ALL', 'Tous les fichiers de la langue en cours du Catalogue et de l\'Admin');

  define('TEXT_INFO_NO_EDIT_AVAILABLE', 'Aucune édition disponible');
  define('TEXT_INFO_CONFIGURATION_HIDDEN', ' ou, CACHÉ');

  define('TEXT_INFO_DATABASE_OPTIMIZE', '<strong>Optimiser la base de données</strong> pour récupérer l\'espace disque gaspillé par les enregistrements effacés. <br />Exécution facultative une fois par semaine ou par mois sur une base de données en activité<br />(préférable de le faire pendant des périodes inoccupées).');
