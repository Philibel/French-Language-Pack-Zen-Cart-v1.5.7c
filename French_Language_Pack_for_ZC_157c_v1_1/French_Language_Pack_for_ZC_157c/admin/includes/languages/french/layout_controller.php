...
define('TABLE_HEADING_BOXES_PATH', 'Chemin d\'accès Boîtes');
define('TEXT_WARNING_NEW_BOXES_FOUND', 'AVERTISSEMENT : Nouvelles boîtes trouvées:');
...
define('TEXT_BAD_BOX','<span style="color:#ff0000;"><b>ABSENT</b></span><br>');
