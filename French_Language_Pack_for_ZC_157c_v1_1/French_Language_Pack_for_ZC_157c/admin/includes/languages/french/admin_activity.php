 ...
 * @version $Id: Benny Philibel 2021-04-10 Modified in v1.5.6 $
 */
...
define('SUCCESS_CLEAN_ADMIN_ACTIVITY_LOG', 'Effacement<strong>terminé</strong>du journal des activités d\'administration');
define('TEXT_NO_RECORDS_FOUND', 'Aucun enregistrement trouvé en utilisant le filtre que vous avez sélectionné.');

define('TEXT_EXPORTFORMAT0', 'Exporter comme HTML (idéal pour la visualisation à l\'écran)');
define('TEXT_EXPORTFORMAT1', 'Exporter au format CSV (idéal pour importer dans des feuilles de calcul)');
define('TEXT_EXPORTFORMAT2', 'Exporter au format TXT');
define('TEXT_EXPORTFORMAT3', 'Exporter au format XML');

define('TEXT_ACTIVITY_EXPORT_FILTER', 'Quelles données de journal voulez-vous voir?');
define('TEXT_EXPORTFILTER0', 'Toutes les données enregistrées, quel que soit le niveau de gravité.');
define('TEXT_EXPORTFILTER1', 'INFO - Informations générales enregistrées');
define('TEXT_EXPORTFILTER2', 'AVIS - Informations importantes, qui devraient être revues périodiquement');
define('TEXT_EXPORTFILTER3', 'AVERTISSEMENT - Activité qui devrait être revue quotidiennement');
define('TEXT_EXPORTFILTER4', 'AVIS et AVERTISSEMENT (combinaison courante pour révision).');
