...
define('TEXT_WARNING_OF_DELETE', '<span class="alert">Cette option est liée à des produits et des valeurs - La supprimer présente des risques.<br />NOTE : Aucun fichier downloadable associé à cette valeur d\'option ne sera supprimé du serveur.</span>');
...
define('PRODUCTS_ATTRIBUTES_EDITING','ÉDITANT'); // title
define('PRODUCTS_ATTRIBUTES_DELETE','EFFACANT'); // title
define('PRODUCTS_ATTRIBUTES_ADDING','AJOUTANT DE NOUVEAUX ATTRIBUTS'); // title
...
// Option Names/Values copier from one to another
  ...
  define('TEXT_SELECT_OPTION_VALUES_TO_CATEGORIES_ID', 'Laissez vide pour TOUS les produits ou<br />entrez un ID de catégorie pour les produits à actualiser');

// Option Name/Value to Option Name for Category with Product defaults
  define('TEXT_OPTION_VALUE_COPY_OPTIONS_TO', '<strong>Copier un nom et une valeur d\'option vers TOUS les produits ayant le nom d\'option ...</strong>');
  define('TEXT_INFO_OPTION_VALUE_COPY_OPTIONS_TO', 'Sélectionnez un nom et une valeur d\'option que vous souhaitez ajouter à tous les produits ou à tous les produits d\'une catégorie déterminée ayant un nom d\'option existant distinct.
        ...
        ');
  define('TEXT_SELECT_OPTION_TO_ADD_TO', 'Ajouter à ce nom d\'option :');
  ...
  define('TEXT_SELECT_OPTION_FROM_PRODUCTS_ID', 'Prendre les nouvelles valeurs par défaut de l\'attribut depuis le produit ID# ou laisser vide pour ne prendre aucune valeur par défaut :');
  ...
  define('ERROR_OPTION_VALUES_COPIED_MISMATCH_PRODUCTS_ID', 'ERREUR : Nom/Valeur d\'option manquant(e) pour le produit ID#');

  define('TEXT_OPTION_VALUE_DELETE_ALL', '<strong>Effacer sur TOUS les produits, l\'attribut ayant le nom et la valeur d\'option ...</strong>');
  ...
  define('SUCCESS_OPTION_VALUES_DELETE', 'Suppression réussie de : ');
  define('LABEL_FILTER', 'Sélectionnez la valeur de l\'option pour filtrer');
  define('TEXT_DISPLAY_NUMBER_OF_OPTION_VALUES', 'Affichage de <b>%d</b> à <b>%d</b> (sur <b>%d</b> valeurs d\’option)');
