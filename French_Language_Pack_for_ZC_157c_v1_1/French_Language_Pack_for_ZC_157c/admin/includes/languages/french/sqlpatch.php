...
WHERE p.othercol_f = pm.othercol_f;</code><br>&nbsp;</li>
  ...
  define('REASON_TABLE_NOT_FOUND', 'Exécution impossible car la table %s n\'existe pas.');
  define('REASON_CONFIG_KEY_ALREADY_EXISTS', 'Impossible d\'insérer la clé de configuration "%s" car elle existe déjà');
  define('REASON_COLUMN_ALREADY_EXISTS', 'Impossible d\'ADD la colonne %s car elle existe déjà.');
  define('REASON_COLUMN_DOESNT_EXIST_TO_DROP', 'Impossible de DROP la colonne %s car elle n\'existe pas.');
  define('REASON_COLUMN_DOESNT_EXIST_TO_CHANGE', 'Impossible de CHANGE la colonne %s car elle n\'existe pas.');
  define('REASON_PRODUCT_TYPE_LAYOUT_KEY_ALREADY_EXISTS', 'Impossible d\'insérer la clé de configuration de prod-type-layout "%s" car elle existe déjà');
  define('REASON_INDEX_DOESNT_EXIST_TO_DROP', 'Impossible de supprimer l\'index %s sur la table %s car il n\'existe pas.');
  define('REASON_PRIMARY_KEY_DOESNT_EXIST_TO_DROP', 'Impossible de supprimer la clé primaire sur la table %s car elle n\'existe pas.');
  define('REASON_INDEX_ALREADY_EXISTS', 'Impossible d\'ajouter l\'index %s à la table %s car il existe déjà.');
  define('REASON_PRIMARY_KEY_ALREADY_EXISTS', 'Impossible d\'ajouter la clé primaire à la table %s car une clé primaire existe déjà.');
  define('REASON_NO_PRIVILEGES', 'Utilisateur'.DB_SERVER_USERNAME.'@'.DB_SERVER.' n\'a pas les privilèges %s sur la base de données '.DB_DATABASE.'.');
  
define('ERROR_RENAME_TABLE', 'La commande RENAME TABLE n\'est pas prise en charge par l\'outil SQLpatch. Veuillez utiliser phpMyAdmin à la place.');
define('ERROR_LINE_INCOMPLETE', 'Requête incomplète : point-virgule de fermeture manquant.');

define('TEXT_EXECUTE_SUCCESS', 'Succès : %u instruction(s) traitée.');
define('ERROR_EXECUTE_FAILED', 'La requête a échoué : %u instruction(s) traitée.');
define('ERROR_EXECUTE_IGNORED', 'Remarque : %u instructions ignorées. Voir la table de base de données "upgrade_exceptions" pour plus de détails.');

define('TEXT_UPLOADQUERY_SUCCESS', 'Succès : %u instruction(s) traitée par téléchargement de fichier');
define('ERROR_UPLOADQUERY_FAILED', 'La requête a échoué : %u instruction(s) traitée par téléchargement de fichier');
define('ERROR_UPLOADQUERY_IGNORED', 'Remarque : %u instructions ignorées via le téléchargement de fichier. Voir le tableau de base de données "upgrade_exceptions" pour plus de détails.');
