 ...
 * @version $Id: Benny Philibel 2021-04-12 Modified in v1.5.6 $
 */
...
define('TEXT_LEGEND_TAX_AND_ZONES', ': Zones et taxes définies');
define('TEXT_LEGEND_ONLY_ZONES', ': Zones définies mais ne pas des taxes');
...
define('TEXT_INFO_DELETE_SUB_ZONE_INTRO', 'Êtes-vous certain(e) de vouloir supprimer cette sous-zone ?');
...
define('TEXT_ALL_ZONES', 'Toutes zones');
define('TEXT_ALL_COUNTRIES', 'Tous les pays');

define('TEXT_INFO_NUMBER_TAX_RATES','Nombre de taux de taxes :');
define('ERROR_TAX_RATE_EXISTS','ATTENTION : Des taux de taxes sont définis pour cette zone. Veuillez supprimer le(s) taux de taxes avant d\'enlever cette zone');
