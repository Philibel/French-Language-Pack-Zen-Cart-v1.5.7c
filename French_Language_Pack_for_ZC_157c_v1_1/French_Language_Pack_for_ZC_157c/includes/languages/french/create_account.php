...
define('EMAIL_DISCLAIMER_NEW_CUSTOMER', 'Cette adresse e-mail nous a été communiquée par vous ou un de nos clients. Si vous n\'avez pas ouvert de compte sur ce site, ou pensez avoir reçu cet e-mail par erreur, veuillez contacter par mail: %s ');
