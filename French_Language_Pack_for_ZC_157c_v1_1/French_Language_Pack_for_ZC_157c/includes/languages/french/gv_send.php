...
define('ERROR_ENTRY_EMAIL_ADDRESS_CHECK', 'L\'adresse e-mail semble incorrecte. Veuillez réessayer.');
define('MAIN_MESSAGE', 'Vous envoyez un ' . TEXT_GV_NAME . ' d\'une valeur de %s à %s dont l\'adresse e-mail est %s. Si ces détails sont incorrects, vous pouvez modifier votre message en cliquant sur le bouton <strong>edit</strong>.<br /><br />Le message que vous envoyez est le suivant:<br /><br />');
...
define('EMAIL_GV_FIXED_FOOTER', 'Si vous éprouvez des difficultés pour encaisser le ' . TEXT_GV_NAME . ' via le lien automatique ci-dessus, ' . "\n" .
