...
define('UNSUBSCRIBE_DONE_TEXT_INFORMATION', '<br />Votre adresse e-mail, indiquée ci-dessous, a été supprimé de notre bulletin, ainsi que vous l\'avez demandé.<br /><br />');
define('UNSUBSCRIBE_ERROR_INFORMATION', '<br />L\'adresse e-mail que vous avez indiquée ne figure pas dans la base de données de notre bulletin, ou a déjà été effacée de notre liste d\'abonnés au bulletin. <br /><br />');
