 ...
 * @version $Id: Benny Philibel 2021-04-03 Modified in v1.5.7 $
 */

// page title
define('TITLE', 'Nom de votre boutique en ligne !');

// Site Tagline
define('SITE_TAGLINE', 'Bienvenue sur notre boutique en ligne !');

// Custom Keywords
define('CUSTOM_KEYWORDS', 'ecommerce, open source, boutique, boutique en ligne');
