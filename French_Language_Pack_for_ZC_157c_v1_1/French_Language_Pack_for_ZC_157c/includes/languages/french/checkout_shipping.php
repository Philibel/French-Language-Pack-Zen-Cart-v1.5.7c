...
define('TEXT_NO_SHIPPING_AVAILABLE','<span class="alert">Désolés, nous ne livrons pas votre région actuellement.</span><br />Veuillez nous contacter pour des mesures alternatives.');
