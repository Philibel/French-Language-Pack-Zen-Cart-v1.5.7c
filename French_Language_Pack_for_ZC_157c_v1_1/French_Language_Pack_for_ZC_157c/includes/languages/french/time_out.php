 ...
 * @version $Id: Benny Philibel 2021-04-05 Modified in v1.5.7c $
 */

define('NAVBAR_TITLE', 'Déconnexion Automatique');
define('HEADING_TITLE', 'Ouups! Votre session a expiré');
define('HEADING_TITLE_LOGGED_IN', 'Ouups! Désolé, mais vous n\'êtes pas autorisé(e) à effectuer l\'action demandée. ');
