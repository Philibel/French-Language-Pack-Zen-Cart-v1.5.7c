...
define('NAVBAR_TITLE', 'Coupon de réduction');
define('HEADING_TITLE', 'Coupon de réduction');
...
define('TEXT_COUPON_HELP_HEADER', '<p class="bold">Le code de remboursement de coupon de réduction que vous avez entré est pour ');
define('TEXT_COUPON_HELP_NAME', '\'%s\'. </p>');
define('TEXT_COUPON_HELP_FIXED', '');
define('TEXT_COUPON_HELP_MINORDER', '<p>Vous avez besoin de dépenser %s pour utiliser ce coupon, sur des produits certifiés.&lt;/p&gt;');
...
define('TEXT_COUPON_HELP_RESTRICT', '<p class="biggerText bold">Restrictions du coupon de réduction</p>');
...
define('TEXT_NO_CAT_RESTRICTIONS', '<p>Ce coupon est valable pour toutes les catégories.</p>');
...
define('TEXT_COUPON_GV_RESTRICTION','<p class="smallText">Les coupons de réduction ne peuvent être appliqué sur l\'achat de ' . TEXT_GV_NAMES . '. Limitation à 1 coupon par commande.</p>');

define('TEXT_DISCOUNT_COUPON_ID_INFO', 'Vérification du coupon de réduction ... ');
