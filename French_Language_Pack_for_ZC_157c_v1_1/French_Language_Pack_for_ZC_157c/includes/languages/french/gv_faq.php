...
define('SUB_HEADING_TEXT', 'Les ' . TEXT_GV_NAMES . ' s\'achètent comme tout autre produit dans notre boutique. Vous pouvez
  ...
  lien vers une page depuis laquelle vous pouvez envoyer votre ' . TEXT_GV_NAME . ' à la personne de votre choix par e-mail.');
  break;
  case '2':
...
define('SUB_HEADING_TEXT','Pour envoyer un ' . TEXT_GV_NAME . ', vous devez vous rendre sur la page ' . TEXT_GV_NAME . ' des envois. Vous pouvez
  ...
  L\'adresse e-mail de la personne à laquelle vous adressez un ' . TEXT_GV_NAME . '.
  ...
  Un court message qui apparaitra dans l\'e-mail.
  Veuillez vous assurer que vous avez entré toutes les informations correctement, bien que
  vous pourrez encore les modifier comme bon vous semble avant que l\'e-mail ne soit vraiment envoyé.');
  break;
  case '3':
...
define('SUB_HEADING_TEXT','Si vous recevez un ' . TEXT_GV_NAME . ' par e-mail, il contiendra les détails concernant
  l\'expéditeur du ' . TEXT_GV_NAME . ', ainsi qu\'un court message de sa part. Cet e-mail
...
define('SUB_HEADING_TEXT','Pour tout renseignement concernant le système de ' . TEXT_GV_NAME . ', veuillez contacter la boutique
  par e-mail à '. STORE_OWNER_EMAIL_ADDRESS . '. Veuillez par ailleurs vous assurer de nous fournir le maximum d\'informations dans l\'e-mail.');
  break;
  default:
