 ...
 * @version $Id: Benny Philibel 2021-04-05 $
 */
...
define('TEXT_NEW_CUSTOMER_INTRODUCTION', 'Créez votre profil client sur <strong>' . STORE_NAME . '</strong>, il va vous permettre d\'acheter plus rapidement, de suivre l\'état de vos commandes en cours et de revoir vos commandes antérieures.');
define('TEXT_NEW_CUSTOMER_INTRODUCTION_SPLIT', 'Vous avez un compte Paypal ? Vous souhaitez payer rapidement avec une carte de crédit ? Utilisez le bouton Paypal ci-dessous pour utiliser l\'option Encaissement Express de Paypal.');
define('TEXT_NEW_CUSTOMER_POST_INTRODUCTION_DIVIDER', '<span class="larger">Ou</span><br />');
define('TEXT_NEW_CUSTOMER_POST_INTRODUCTION_SPLIT', 'Créez votre profil client sur <strong>' . STORE_NAME . '</strong>, il va vous permettre d\'acheter plus rapidement, de suivre l\'état de vos commandes en cours, de revoir vos commandes antérieures et de profiter des avantages de nos autres membres.');
...
define('TEXT_LOGIN_ERROR', 'ERREUR: Désolé, aucune correspondance pour cette adresse e-mail et ce mot de passe.');
