...
/*
 * ALT text is used as Button Text, or for the ALT tag on image-buttons: Le texte ALT est utilisé comme texte de bouton, ou pour la balise ALT sur les boutons d\'image
 */

define('BUTTON_CREATE_ACCOUNT_ALT', 'S\'inscrire');
define('BUTTON_LOG_OFF_ALT', 'Se déconnecter');
define('BUTTON_ADD_ADDRESS_ALT', 'Ajoutez l\'adresse');
...
define('BUTTON_CONTACT_US_TEXT', 'Nous contacter');
...
define('BUTTON_VIEW_ALL_ALT', 'Voir tout');
define('BUTTON_ASK_A_QUESTION_ALT', 'Poser une question');
